			...
			<div class="container">
				<div class="row">
					...
					<div class="section-head" style="text-align: left !important; margin-bottom:40px">
						...
						<h4><strong style="text-decoration: underline !important">Step Two - Project Skillset(s)</strong></h4>
					</div>
					...
					<div class="col-md-12">
						...
						<!-- contact info -->
						<!-- contact form -->
						<form class="form" method="post" action="/new-project-step-two">
		                    ...
		                    <div class="controls">
								...
								<div class="row">
									<div class="col-md-12">
										<label>Select The Artisan Skillsets Needed For This Project (Max. of 12):<span style="color: red">*</span></label>
									</div>
		                            <div class="col-md-12">
										<?php $i=0; ?>
										@foreach($skills as $skill)
											<div class="form-group col-md-3">
												<input type="checkbox" name="skills[]" value="{{$skill->id}}"> <small>&nbsp;&nbsp;{{ucwords($skill->skill_name)}}</small>
											</div>
										@endforeach
		                            </div>
		                        </div>
