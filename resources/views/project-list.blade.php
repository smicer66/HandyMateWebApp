		...
		<section class="contact section-padding" data-scroll-index="6">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10">
						<u style="float: left !important;"><h5 style="padding-bottom: 15px !important;"><strong style="text-decoration: underline !important">All Projects</strong></h5></u>
											...
											@foreach($projects as $project)
												<div class="col-md-4" style="padding-left: 3px; padding-right: 3px !important;">
													<div style="font-size: 13px !important; background-color: #f4f4f4 !important; border-radius: 5px !important; padding-top: 10px; padding-bottom: 10px" class="col-md-12">
														...
														<span style="float: right !important">{{date('d, F Y', strtotime($project->expected_completion_date))}}</span><br>
														<span style="text-decoration:underline !important">Project Location:</span>
														...
														?>
														<span style="text-decoration:underline !important">Skills Required:</span>
														<span style="float: right !important">{{join(', ', $skills)}}</span><br>
