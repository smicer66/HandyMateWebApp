			...
			<div class="container">
				<div class="row">
					...
					<div class="section-head" style="text-align: left !important; margin-bottom:40px">
						<h3>Step Four - Preview Your Artisan Details</h3>
					</div>
					...
					<div class="col-md-12">
						...
						<!-- contact info -->
						<!-- contact form -->
						<form class="form" method="post" action="/register-artisan-step-four">
		                    ...
		                    <div class="controls">
								...
								<u><h5 style="padding-bottom: 15px !important;"><strong style="text-decoration: underline !important">Your Specified Skillsets</strong></h5></u>
		                            ...
		                            <div class="col-md-12">
										...
										@foreach($skills as $skill)
											<div class="form-group col-md-4">
												<i class="fa fa-check"></i> {{ucwords($skill->skill_name)}}
											</div>
										@endforeach
		                            </div>
		                        </div>
								...
								<div class="row" style="padding-bottom: 15px !Important">
		                            ...
		                            <div class="col-md-4">
		                                <div class="form-group">
		                                    ...
		                                    {{$stepThreeData->guarantor_firstname}}
		                                </div>
		                            </div>
		                             ...
		                             <div class="col-md-4">
		                                <div class="form-group">
		                                    ...
		                                    {{isset($stepThreeData->guarantor_othername) && strlen($stepThreeData->guarantor_othername)>0 ? $stepThreeData->guarantor_othername : 'N/A'}}
		                                </div>
		                            </div>
		                             ...
		                             <div class="col-md-4">
		                                <div class="form-group">
		                                    ...
		                                    {{$stepThreeData->guarantor_lastname}}
		                                </div>
		                            </div>
		                        </div>
								...
								<div class="row" style="padding-bottom: 15px !Important">
		                            <div class="col-md-8">
		                                <div class="form-group">
		                                    ...
		                                    {{$stepThreeData->guarantor_address}}
		                                </div>
		                            </div>
								...
								<div class="row" style="padding-bottom: 15px !Important">
		                            <div class="col-md-4">
		                                <div class="form-group">
		                                    ...
		                                    {{explode('|||', $stepThreeData->guarantor_country)[1]}}
		                                </div>
		                            </div>
								...
								<div class="row" style="padding-bottom: 15px !Important">
		                             ...
		                             <div class="col-md-4">
		                                <div class="form-group">
											<div class="col-md-12" style="padding-left: 5px !important; padding-right: 0px !important;">
												...
												+{{$stepThreeData->guarantor_prefix}}{{$stepThreeData->guarantor_mobileNumber}}
											</div>
		                                </div>
		                            </div>
		                             ...
		                             <div class="col-md-4">
		                                <div class="form-group">
		                                    ...
		                                    {{$stepThreeData->guarantor_gender}}
		                                </div>
		                            </div>
		                        </div>
