			...
			<div class="container">
				<div class="row">
					...
					<div class="section-head" style="text-align: left !important; margin-bottom:40px">
						...
						<u><h4 style="padding-bottom: 15px !important;"><strong style="text-decoration: underline !important">Step Two - Select a Maximum of 12 Skills</strong></h4></u>
					</div>
					...
					<div class="col-md-12">
						...
						<!-- contact info -->
						<!-- contact form -->
						<form class="form" method="post" action="/register-artisan-step-two">
		                            ...
		                            <div class="col-md-12">
										...
										@foreach($skills as $skill)
											<div class="form-group col-md-4">
												<input type="checkbox" name="skills[]" value="{{$skill->id}}"> &nbsp;&nbsp;{{ucwords($skill->skill_name)}}
											</div>
										@endforeach
		                            </div>
		                        </div>
