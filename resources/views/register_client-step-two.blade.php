			...
			<div class="container">
				<div class="row">
					...
					<div class="section-head" style="text-align: left !important; margin-bottom:40px">
						...
						<u><h5 style="padding-bottom: 15px !important;"><strong style="text-decoration: underline !important">Step Three - Tell Us About Yourself</strong></h5></u>
					</div>
					...
					<div class="col-md-12">
						...
						<!-- contact info -->
						<!-- contact form -->
						<form class="form" method="post" action="/register-client-step-two">
