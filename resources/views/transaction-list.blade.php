		...
		<section class="contact section-padding" data-scroll-index="6">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<u style="float: left !important;"><h5 style="padding-bottom: 15px !important;"><strong style="text-decoration: underline !important">All My Transactions</strong></h5></u>
							...
							<div class="row" style="padding-bottom: 15px !Important">
								<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-12" style="padding-left: 3px; padding-right: 3px !important;">
												<table class="table col col-md-12">
													...
													<tbody>
														@foreach($transactions as $transaction)
															@if(isset($transaction->project))
															<tr>
																<td>{{date('Y M, d', strtotime($transaction->created_at))}}</td>
																<td>{{join('-', str_split($transaction->reference_no, 4))}}</td>
																@if(isset($transaction->project))
																<td><a href="/project-details/{{$transaction->project->project_url}}">{{$transaction->project->title}}</a></td>
																@else
																<td>N/A</td>
																@endif
																...
																<td style="text-align: right !important">{{number_format($transaction->total_amount, 2, '.', ',')}}</td>
																<td><a href="/" class="btn btn-info">Receipt</a></td>
